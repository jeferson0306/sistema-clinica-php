        ...
        <aside class="sidebar-left" style="overflow: scroll; height:100%; scrollbar-width: thin;">
            <nav class="navbar navbar-inverse">
                <div class="navbar-header">
                    ...
                    <h1><a class="navbar-brand" href="index.php"><span class="fa fa-cutlery"></span> Clinics<span class="dashboard_text">Sistema para Clinicas</span></a></h1>
                </div>
        ...
        <div class="modal-content">
            ...
            <form id="form-config">
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <label>Sistema para Clinicas</label>
